            ...
            <div className={classes.mainBlog}>
              ...
              <div className={classes.mainBlogData}>
                ...
                <div className={classes.authorAndCreatedAt}>
                  <span><span>Author:</span> Hiran V M</span>
                  <span><span>Created:</span>20-07-2023</span>
                </div>
              </div>
            </div>
          </div>
          <div className={classes.right}>
            <div className={classes.secondaryBlog}>
              ...
              <div className={classes.secondaryBlogData}>
                ...
                <div className={classes.authorAndCreatedAt}>
                  <span><span>Author:</span> Akshay V S</span>
                  <span><span>Created:</span> 19-07-2023</span>
                </div>
              </div>
            </div>
            <div className={classes.secondaryBlog}>
              ...
              <div className={classes.secondaryBlogData}>
                ...
                <div className={classes.authorAndCreatedAt}>
                  <span><span>Author:</span> Anek V J</span>
                  <span><span>Created:</span> 21-07-2023</span>
                </div>
              </div>
            </div>
          </div>
